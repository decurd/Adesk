package kr.co.roonets.adesk.utils;
...
import kr.co.roonets.adesk.component.CircularProgressDialog;
...
public class DialogUtil {
    ...
    public static Dialog showInformationDialog(Context c, String 통신오류, String message) {
    ...
    public static Dialog showConfirmDialog(Context c, String title, String message) {
        return showConfirmDialog(c, title, message);
    }
...
//                        PreferenceUtil.getInstance().setString(PreferenceUtil.PREF_LOGIN_PASSWD, null);
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (c instanceof MainActivity) {
                    ...
                    PreferenceUtil.getInstance().setString(PreferenceUtil.PREF_LOGIN_ID, null);
                    PreferenceUtil.getInstance().setString(PreferenceUtil.PREF_LOGIN_PASSWD, null);
                    PreferenceUtil.getInstance().setString(PreferenceUtil.PREF_TOKEN, null);
     ...
     * @return
     */
    public static Dialog showSaveInfo(final Context c, final boolean b) {
        ...
        DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (b) {
                    ((MainActivity)MainActivity.mContext).beginAutoLogin(b);
                }
                ...
                ((MainActivity)MainActivity.mContext).mDrawerActionHandler.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        ((MainActivity)MainActivity.mContext).mDrawer.closeDrawer();
                    }
                }, 0);
            }
        };

        return showDialog(c, "알림", msg, listener);
    }
}
